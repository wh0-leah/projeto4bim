...
export class UsuarioRepository {
  ...
  */
  ...
  // Retorna uma lista contendo apenas as informações públicas dos usuários que estão ativos no sistema
  static listarAtivos() {
    return this.collection.filter(u => u.ativo).map(u => u.toPublicJSON());
  }
